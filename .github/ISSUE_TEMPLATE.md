...
<!-- system, opcua server or client type, package manager, equipment, vendor info -->
  ...
  * ( ) I am using just the Node-RED package and got jsonwebtoken installed with it
  * ( ) I have installed jsonwebtoken global from source (using git clone)
  * ( ) I have installed jsonwebtoken as a global package (using npm i -g)
